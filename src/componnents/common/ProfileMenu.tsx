            ...
            >
                ...
                >
                    <ListItem sx={{px: 2, py: 1}}
                              secondaryAction={<Typography variant={"caption"}>ID: #{user!.id}</Typography>}>
                        <Avatar
                    ...
                    <Tooltip
                        title={
                            user!.accounts.length < 1
                                ? "Add an account via Settings first"
                                : ""
                        }
                        arrow
                        disableHoverListener={user!.accounts.length >= 1} // désactive le tooltip si actif
                    >
                      <span>
                          <MenuItem
